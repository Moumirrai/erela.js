...
type LoadType = "TRACK_LOADED" | "PLAYLIST_LOADED" | "SEARCH_RESULT" | "LOAD_FAILED" | "NO_MATCHES";
...
declare class Endpoints {
    static LAVALINK_API_VERSION: number;
    static SESSIONS: (sessionId: string) => string;
    static PLAYER: (sessionId: string, guildId: string) => string;
    static LOAD_TRACKS: (identifier: string) => string;
    static DECODE_TRACKS: () => string;
    static DECODE_TRACK: () => string;
    static ROUTE_PLANNER_STATUS: () => string;
    static ROUTE_PLANNER_FREE_ADDR: () => string;
    static ROUTE_PLANNER_FREE_ALL: () => string;
...
interface LoadTracksResult extends LoadResultBase {
    tracks: TrackData[];
}
type Info = {
    version: {
...
declare class Node {
    ...
    /** Rest instance for the node */ rest: Rest | null;
...
type SearchPlatform = "youtube" | "youtube music" | "soundcloud";
