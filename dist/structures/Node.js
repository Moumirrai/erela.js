...
const Rest_1 = require("./Rest"); //MODIFIED
...
class Node {
    ...
    constructor(options) {
        ...
        this.rest = new Rest_1.Rest(this); //MODIFIED
    ...
    connect() {
        ...
        if (this.options.rest) { //MODIFIED
            wsUrl += `/v${Rest_1.Endpoints.LAVALINK_API_VERSION}/websocket`; //MODIFIED
        } //MODIFIED
        this.socket = new ws_1.default(wsUrl, //MODIFIED
        { headers });
